...
SXPM has setups to allow for running it on Synergy, HL2:DM, ~Obsidian~, and Insurgency (although most of the menus don't work in Insurgency).
...
Where 1 is easy, 2 is normal, 3 is hard.
